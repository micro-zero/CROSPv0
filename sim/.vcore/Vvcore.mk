...
include Vvcore_classes.mk
# Include global rules
include $(VERILATOR_ROOT)/include/verilated.mk

### Library rules from --lib-create
libvcore.a: $(VK_OBJS) $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) vcore.o $(VM_HIER_LIBS)

libvcore.so: $(VK_OBJS) $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) vcore.o $(VM_HIER_LIBS)
...
libvcore: libvcore.a libvcore.so
