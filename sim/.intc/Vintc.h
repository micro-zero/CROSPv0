...
#ifndef VERILATED_VINTC_H_
#define VERILATED_VINTC_H_  // guard

#include "verilated.h"
#include "verilated_save.h"

class Vintc__Syms;
class Vintc___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vintc VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit Vintc(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vintc(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vintc();
  private:
    VL_UNCOPYABLE(Vintc);  ///< Copying not allowed
  ...
  public:
    ...
    friend VerilatedSerialize& operator<<(VerilatedSerialize& os, Vintc& rhs);
    friend VerilatedDeserialize& operator>>(VerilatedDeserialize& os, Vintc& rhs);
